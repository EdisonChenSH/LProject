...
extern u8 uartec[10];  //设置CANID数据缓冲
extern u8 uartnum;
...
//void jsetcanIDFsh(u32 start,u8 *buf,u32 len);
void jcopy(u8 *strbuf,u8 len,u32 frpos);
//BOOL jsetcanID(FileInfoStruct *FileName,u8 *strbuf,u8 len);
void clearjpgbuff(void);
